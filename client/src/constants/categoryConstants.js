...
export const CATEGORY_SUB_GET_REQUEST = "CATEGORY_SUB_GET_REQUEST";
export const CATEGORY_SUB_GET_SUCCESS = "CATEGORY_SUB_GET_SUCCESS";
export const CATEGORY_SUB_GET_FAIL = "CATEGORY_SUB_GET_FAIL";
export const CATEGORY_SUB_GET_RESET = "CATEGORY_SUB_GET_RESET";